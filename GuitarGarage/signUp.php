  ...
  <div class="center">
   ...
   <form action="signup-script.php" method="POST"> 
     ...
     <div class="input-block">
         ...
         <input type="text" name="e-mail" placeholder="E-mail" required ><?php echo $_GET['m1'];?>
     </div>
     <div class="input-block">
     ...
     <div class="input-block">
         ...
         <input type="tel" id="phone" name="contact"  placeholder="Enter your phone" required><?php echo $_GET['m2'];?>
     </div>
     <div class="input-block">
